...
int main(int argc, char *argv[])
{
   ...
   while(ppid!=0){//ppid 0 olana kadar döngü devam eder	
   	...
   	char* pername = get_name(pid); //yeni pid değeri için komut bulunur
   	
   	print_process_info(pid, ppid, pername); //yeni pid değeri için bilgiler ekrana çıktı olarka üretilir
